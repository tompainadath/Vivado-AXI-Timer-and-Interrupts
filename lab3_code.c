...
//	//led_data = led_data + btn_value;
//
//	if(btn_value == 0b0010 && sw_value == 0b0010)
//	{
//		if(tmr_limit < 7 )
//			tmr_limit++;
//	}
//	else if(btn_value == 0b0100  && sw_value == 0b0100)
//	{
//		if(tmr_limit > 1 )
//			tmr_limit--;
//	}
...
//			tmr_count = 0;
//			led_data++;
//			xil_printf("led count = %d\n", led_data);
//			xil_printf("btn count = %d\n", btn_value);
//			xil_printf("sw_value  = %d\n", sw_value);
//
//			XGpio_DiscreteWrite(&LEDInst, 1, led_data);
//			XTmrCtr_Reset(&TMRInst,0);
//			XTmrCtr_Start(&TMRInst,0);
...
//  while(1)
//  {
//	  sw_value = XGpio_DiscreteRead(&LEDInst, 2);
//
//	  //if (sw_value > 0)
//		//  xil_printf("switch = %d\n", sw_value);
//
